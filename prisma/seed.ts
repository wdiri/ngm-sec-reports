...
async function main() {
  ...
  const baseValues: Record<number, number[]> = {
    1: [85, 87, 89, 91, 92, 93, 94, 95], // Improving
    2: [88, 90, 92, 91, 93, 94, 95, 96], // Improving
    3: [30, 28, 26, 25, 24, 23, 22, 21], // Improving (lower is better)
    4: [82, 84, 86, 88, 89, 90, 91, 92], // Improving
    5: [12, 11, 10, 9, 8, 7, 6, 5], // Improving (lower is better)
    6: [78, 80, 82, 84, 85, 86, 87, 88], // Improving
    7: [4, 3.5, 3, 2.5, 2.5, 2, 2, 2], // Improving (lower is better)
    8: [8, 7, 6, 5.5, 5, 4.5, 4, 4], // Improving (lower is better)
    9: [88, 90, 91, 92, 93, 94, 95, 96], // Improving
    10: [2, 2, 3, 3, 3, 4, 4, 4], // Improving
    11: [75, 78, 80, 82, 85, 88, 90, 92], // Improving
  };
  ...
  for (let i = 0; i < months.length; i++) {
    ...
    console.log(`Created period ${period.label} with ${METRIC_DEFINITIONS.length} metrics`);
  }
